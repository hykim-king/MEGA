...
class MembershipDaoTest {
    ...
    void setUp() throws Exception {
        ...
        dto01 = new MembershipDTO("userA01", "adminA01", "userA01@test.com", "pwA!23",
                Date.valueOf("1992-05-12"), "Y", "tokA1234XYZ", 2, "profileA.png", Date.valueOf("2025-05-12"));
        dto02 = new MembershipDTO("userA02", "adminA01", "userA02@test.com", "pwA!23",
                Date.valueOf("1992-05-12"), "Y", "tokA1234XYZ", 2, "profileA.png", Date.valueOf("2025-05-12"));
        dto03 = new MembershipDTO("userA03", "adminA01", "userA03@test.com", "pwA!23",
                Date.valueOf("1992-05-12"), "Y", "tokA1234XYZ", 2, "profileA.png", Date.valueOf("2025-05-12"));
