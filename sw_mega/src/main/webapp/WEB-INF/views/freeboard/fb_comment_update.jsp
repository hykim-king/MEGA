...
<form id="updateForm">
    ...
    <input type="hidden" id="fbCode" value="${vo.fbCode}" />
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (result.messageId === 1) {
                    const fbCode = encodeURIComponent($("#fbCode").val());
                    location.href = "/ehr/freeboard/doDetail.do?fbCode=" + fbCode + "&pageSize=10&pageNo=1";
                } else {
    ...
    function likeTarget(type, id) {
        $.ajax({
            ...
            data: JSON.stringify({
                ...
                reactionType: "L",            // 좋아요
                targetType: type.toUpperCase(), // "freeboard" 또는 "COMMENT"
                targetCode: id
            }),
