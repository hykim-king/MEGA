    ...
    <script>
        $(function(){
            $("#moveToReg").click(function(){
                ...
                window.location.href = "${CP}/freeboard/doSaveView.do";
            });
...
<div id="container">
    ...
    <main class="main-container">
        <div class="list-container">
            ...
            <!--검색 영역-->
            <form action="${CP}/freeboard/doRetrieve.do" name="userForm" class="search-form" method="get">
