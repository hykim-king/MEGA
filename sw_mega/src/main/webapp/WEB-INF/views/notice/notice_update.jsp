...
<form id="updateForm">
    <input type="hidden" id="noCode" name="noCode" value="${vo.noCode}" />
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (result.messageId === 1) {
                    location.href = "${CP}/notice/doDetail.do?noCode=" + noCode + "&pageSize=10&pageNo=1";
                }
            },
