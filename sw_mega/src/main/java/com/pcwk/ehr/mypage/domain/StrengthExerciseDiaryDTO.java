 ...
 * Class Name: StrengthExerciseDTO.java <br/>
 * Description:  <br/>
...
public class StrengthExerciseDiaryDTO {
	...
	public StrengthExerciseDiaryDTO() {
	}
	 ...
	 * @param regDt
	 */
	public StrengthExerciseDiaryDTO(String edCode, String userId, String eCode, String exerciseName, String region,
			int strenthWeight, int setCount, int repsPerSet, int duration, int calBurned, String regDt) {
		super();
		this.edCode = edCode;
		this.userId = userId;
		this.eCode = eCode;
	...
	public String toString() {
		return "StrengthExerciseDiaryDTO [edCode=" + edCode + ", userId=" + userId + ", eCode=" + eCode
				+ ", exerciseName=" + exerciseName + ", region=" + region + ", strenthWeight=" + strenthWeight
				+ ", setCount=" + setCount + ", repsPerSet=" + repsPerSet + ", duration=" + duration + ", calBurned="
				+ calBurned + ", regDt=" + regDt + "]";
	}
